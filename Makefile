...
.PHONY: download
download: clean
	curl -L -O https://github.com/AikidoSec/firewall-java/releases/download/v1.0.9/zen.zip
...
run:
	...
	AIKIDO_BLOCK=1 java -javaagent:$(JAVA_AGENT) -DportNumber=8080 -jar $(JAR_FILE) -Xmx256m -XX:+UseContainerSupport
